...
<section class="s1lua-hero">
  ...
  <div class="s1lua-actions">
    <a class="s1lua-action s1lua-action-primary" href="docs/getting-started.md">Make your first mod</a>
    <a class="s1lua-action" href="docs/reference.md">Browse the Lua API</a>
  </div>
</section>
...
<section class="s1lua-section" aria-labelledby="what-you-can-make">
  ...
  <div class="s1lua-grid">
    <a class="s1lua-card" href="docs/getting-started.md">
    ...
    <a class="s1lua-card" href="docs/reference.md#events">
...
<section class="s1lua-next">
  ...
  <a class="s1lua-action s1lua-action-primary" href="docs/getting-started.md">Open the walkthrough</a>
</section>
