...
internal static class GeneratedSurface
{
    ...
    internal static readonly SurfaceBindingInfo[] Bindings =
    {
        ...
        new("s1.time", "s1.time() -> S1LuaTimeInfo|nil", "Returns the current game-time snapshot, or nil outside a loaded game."),
        new("s1.weather", "s1.weather() -> S1LuaWeatherInfo|nil", "Returns current weather weights, or nil before weather is available."),
        ...
        new("mod.npc", "mod:npc(id) -> S1LuaNpc", "Creates a reload-safe proxy for an existing NPC ID."),
        ...
        new("mod.quest", "mod:quest(name) -> S1LuaQuest", "Creates a read-only proxy for a known base-game quest title or compact ID."),
        new("npc.info", "npc:info() -> S1LuaNpcInfo|nil", "Returns a primitive NPC snapshot, or nil while that NPC is unavailable."),
        ...
        new("quest.info", "quest:info() -> S1LuaQuestInfo|nil", "Returns a primitive quest snapshot, or nil before the quest is available."),
